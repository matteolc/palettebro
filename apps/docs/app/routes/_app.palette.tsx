  ...
  return (
    <>
      <PageHeader>
        ...
        <PageHeaderDescription>
          Here you can find all the color shades used in the palette, along with their <a href="https://www.w3.org/TR/WCAG22/">WCAG 2.2</a> and <a href="https://www.w3.org/TR/WCAG3/">WCAG 3.0</a> contrast grades.
        </PageHeaderDescription>
        <PageActions>
