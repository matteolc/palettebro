...
const NavigationHeader = () => {
  ...
  return (
    <motion.header
      ...
      className={clsx(
        'left-0 max-w-2xl lg:max-w-full right-0 py-1  fixed inset-x-3 top-4 z-50 mx-auto flex justify-center overflow-hidden rounded-lg transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1.03)] will-change-transform',
        isScrolled
