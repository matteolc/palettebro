...
const ColorField: FC<ColorFieldProps> = ({ value, token, onChange }) => {
    ...
    <div className="h-[30.5rem]">
      <Tabs defaultValue="lch">
        ...
        <TabsContent value="rgb">
          <RGBColorField value={schemistColor} onChange={handleChange} />
        </TabsContent>
        <TabsContent value="hsl">
          <HSLColorField value={schemistColor} onChange={handleChange} />
        </TabsContent>
        <TabsContent value="lch">
          <LCHColorField value={schemistColor} onChange={handleChange} />
        </TabsContent>

        <TabsContent value="css">
          <CSSColorField value={schemistColor} onChange={handleChange} />
        </TabsContent>
        <TabsContent value="tw">
          <TailwindColorField token={token} />
        </TabsContent>
        <TabsContent value="pantone">
          <PantoneColorField token={token} />
        </TabsContent>
        <TabsContent value="ral">
          <RALColorField token={token} />
        </TabsContent>
      </Tabs>
    </div>
  );
