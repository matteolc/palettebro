...
export const Default: Story<ThemeProps> = (args) => {
  ...
  return (
    <div>
      <h4 className="mb-4">Current Theme: {theme as string}</h4>
        ...
        {Object.keys(defaultThemes).map((t) => (
          <ThemeItem
            ...
            onClick={() => {
              ...
              window.localStorage.setItem('sb-react-preview-theme', t);
              setTheme(t);
            }}
          />
        ))}
      ...
      nodes.push(
        <ThemeItem
          ...
          onClick={(e) => {
            ...
            window.localStorage.setItem('sb-react-preview-theme', themes[i]);
            setTheme(themes[i]);
          }}
        >
          <ThemeItem
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-y-4">
        {renderNestedThemes(Object.keys(defaultThemes))}
      </div>
    </div>
  );
};
