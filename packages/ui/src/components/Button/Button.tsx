...
const buttonVariants = tv({
  ...
  variants: {
    ...
    variant: {
      primary: [
        'text-primary-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.primary.500)] [--btn-border:theme(colors.primary.600/80%)]',
      ...
      secondary: [
        'text-secondary-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.secondary.500)] [--btn-border:theme(colors.secondary.600/80%)]',
      ...
      accent: [
        'text-accent-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.accent.500)] [--btn-border:theme(colors.accent.600/80%)]',
        '[--btn-icon:theme(colors.accent.300)] data-[active]:[--btn-icon:theme(colors.accent.200)] data-[hover]:[--btn-icon:theme(colors.accent.200)]',
      ],
      success: [
        'text-success-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.success.500)] [--btn-border:theme(colors.success.600/80%)]',
        '[--btn-icon:theme(colors.success.300)] data-[active]:[--btn-icon:theme(colors.success.200)] data-[hover]:[--btn-icon:theme(colors.success.200)]',
      ],
      error: [
        'text-error-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.error.500)] [--btn-border:theme(colors.error.600/80%)]',
        '[--btn-icon:theme(colors.error.300)] data-[active]:[--btn-icon:theme(colors.error.200)] data-[hover]:[--btn-icon:theme(colors.error.200)]',
      ],
      warning: [
        'text-warning-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.warning.500)] [--btn-border:theme(colors.warning.600/80%)]',
        '[--btn-icon:theme(colors.warning.300)] data-[active]:[--btn-icon:theme(colors.warning.200)] data-[hover]:[--btn-icon:theme(colors.warning.200)]',
      ],
      info: [
        'text-info-content [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.info.500)] [--btn-border:theme(colors.info.600/80%)]',
        '[--btn-icon:theme(colors.info.300)] data-[active]:[--btn-icon:theme(colors.info.200)] data-[hover]:[--btn-icon:theme(colors.info.200)]',
      ],
    },
  },
  defaultVariants: {
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const Component = asChild ? Slot : HeadlessButton;
    return (
      <Component
        ref={forwardedRef}
        className={cx(
          buttonVariants({ variant, solid, outline, plain, color, block }),
          className,
        )}
        disabled={disabled}
