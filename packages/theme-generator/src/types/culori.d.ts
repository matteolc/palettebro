...
declare module 'culori/fn' {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: TODO: culori/fn types
  export function formatHex(color: any): string;

  export function convertHslToRgb(color: Culori.Hsl): Culori.Rgb;

  export function convertLabToLch(color: Culori.Lab): Culori.Lch;
  ...
  export function convertLchToLab(color: Culori.Lch): Culori.Lab;
  ...
  export function convertOklabToOkhsl(color: Culori.Oklab): Culori.Okhsl;

  export function convertOklabToRgb(color: Culori.Oklab): Culori.Rgb;

  export function convertRgbToHsl(color: Culori.Rgb): Culori.Hsl;

  export function convertRgbToLab(color: Culori.Rgb): Culori.Lab;

  export function convertRgbToOklab(color: Culori.Rgb): Culori.Oklab;
